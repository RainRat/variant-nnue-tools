...
void on_prune_at_shallow_depth(const Option& o) { Search::prune_at_shallow_depth = o; }
void on_enable_transposition_table(const Option& o) { TranspositionTable::enable_transposition_table = o; }

void on_nnue_change(const Option& ) { Eval::NNUE::init(); }
void on_use_NNUE(const Option& o) { on_nnue_change(o); }
